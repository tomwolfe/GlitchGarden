...
export const LoadingOverlay: React.FC<LoadingOverlayProps> = ({ 
  ...
  return (
    <div className="loading-overlay" role="status" aria-live="polite" aria-atomic="true">
      ...
      {/* Progress Bar */}
      <div className="w-64 md:w-96 bg-gray-700 rounded-full h-6 overflow-hidden border-4 border-gray-600" role="progressbar" aria-valuenow={progress} aria-valuemin={0} aria-valuemax={100} aria-label="Loading progress">
        <div
      ...
      {/* Decorative Stars */}
      <div className="absolute top-20 left-10 text-4xl animate-float" style={{ animationDelay: '0s' }} aria-hidden="true">✨</div>
      <div className="absolute top-32 right-20 text-3xl animate-float" style={{ animationDelay: '0.5s' }} aria-hidden="true">⭐</div>
      <div className="absolute bottom-32 left-20 text-3xl animate-float" style={{ animationDelay: '1s' }} aria-hidden="true">💫</div>
      <div className="absolute bottom-20 right-10 text-4xl animate-float" style={{ animationDelay: '1.5s' }} aria-hidden="true">✨</div>
    </div>
  );
};
